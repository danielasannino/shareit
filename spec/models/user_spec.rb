...
RSpec.describe User, type: :model do
  ...
  it { should allow_value("user@shareit.com").for(:email) }
  it { should_not allow_value("usershareit.com").for(:email) }
  ...
  describe "invalid user" do
    ...
    let(:user_with_invalid_email_format) { User.new(name: "Shareit User", email: "invalid_format") }
